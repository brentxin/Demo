...
package com.mason.brent.toolbar.bean;
...
public final class Repo extends Table {
  ...
  public static int createRepo(FlatBufferBuilder builder,
      ...
      boolean has_pages,
      int forks_count,
      int mirror_urlOffset,
      int open_issues_count,
      int forks,
      int open_issues,
      int watchers,
      int default_branchOffset) {
    builder.startObject(67);
    Repo.addSize(builder, size);
    Repo.addId(builder, id);
    Repo.addDefaultBranch(builder, default_branchOffset);
    ...
    Repo.addMirrorUrl(builder, mirror_urlOffset);
    Repo.addForksCount(builder, forks_count);
    Repo.addLanguage(builder, languageOffset);
    Repo.addWatchersCount(builder, watchers_count);
    Repo.addStargazersCount(builder, stargazers_count);
    Repo.addHomepage(builder, homepageOffset);
    Repo.addSvnUrl(builder, svn_urlOffset);
    Repo.addCloneUrl(builder, clone_urlOffset);
    Repo.addSshUrl(builder, ssh_urlOffset);
    Repo.addGitUrl(builder, git_urlOffset);
    Repo.addPushedAt(builder, pushed_atOffset);
    Repo.addUpdatedAt(builder, updated_atOffset);
    Repo.addCreatedAt(builder, created_atOffset);
    Repo.addUrl(builder, urlOffset);
